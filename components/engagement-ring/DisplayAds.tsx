...
function SnapBadge() {
  return (
    <div className="flex items-center gap-1">
      ...
      <span style={{ fontFamily: 'Aeonik, sans-serif', fontSize: 9, fontWeight: 700, color: GOLD, letterSpacing: '0.05em', textTransform: 'uppercase' }}>
        Snap Finance
      </span>
    </div>
  )
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          ...
          <div>
            ...
            <p style={{ fontFamily: 'Aeonik, sans-serif', fontSize: 11, color: 'rgba(255,255,255,0.55)', margin: 0 }}>
              Kay · Zales · Jared — No credit needed
            </p>
          </div>
        </div>
        {/* Right: CTA */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <p style={{ fontFamily: 'Aeonik, sans-serif', fontSize: 12, color: 'rgba(255,255,255,0.6)', margin: 0 }}>
            Pay weekly from <strong style={{ color: '#fff' }}>$18/wk</strong>
          </p>
          <div style={{
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <img src="/images/engagement_main.png" alt="" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center bottom' }} />
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontFamily: 'Aeonik, sans-serif', fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 16 }}>
            We make it possible.<br />Pay over time.
          </p>
        ...
        {/* decorative rings */}
        <div style={{ position: 'absolute', right: -40, top: 40, width: 120, height: 120, borderRadius: '50%', border: `1px solid ${GOLD}20` }} />
        <div style={{ position: 'absolute', right: -20, top: 60, width: 80, height: 80, borderRadius: '50%', border: `1px solid ${GOLD}15` }} />
      </div>
    </div>
  )
}
      ...
      <div className="flex flex-wrap gap-10 items-start">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-100 max-w-xs">
            <p className="text-[#c9a060] text-[10px] font-bold tracking-widest uppercase mb-3">Targeting Logic</p>
            <ul className="space-y-2 text-xs text-[#6b7280] leading-relaxed">
              <li>🔍 <strong className="text-[#353849]">Search trigger:</strong> "engagement rings near me," "diamond ring financing," "propose 2026"</li>
              <li>📍 <strong className="text-[#353849]">Geo:</strong> Salt Lake City, Albuquerque NM, Denver CO, Sacramento CA</li>
              <li>👤 <strong className="text-[#353849]">Demo:</strong> Adults 24–38, relationship milestone signals</li>
              <li>📅 <strong className="text-[#353849]">Flight:</strong> Year-round · Peak: Nov 1 – Feb 14</li>
            </ul>
          </div>
        </div>
      </div>
