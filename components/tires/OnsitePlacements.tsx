  ...
  return (
    <div>
      ...
      <div style={{
        ...
        background: `linear-gradient(135deg, ${DARK} 0%, #1c1c22 65%, #0f0f12 100%)`,
        ...
        {/* Decorative rings */}
        <div style={{ position: 'absolute', right: 0, top: 0, width: 400, height: 400, borderRadius: '50%', border: `1px solid ${ORANGE}10`, transform: 'translate(30%, -30%)' }} />
        ...
        <div style={{ maxWidth: 400 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: 14, lineHeight: 1.6, marginBottom: 24 }}>
            Big O · Discount Tire · Les Schwab · Local Shops<br />
            Safety shouldn't wait. Apply in seconds.
          </p>
          <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
            <div style={{ background: ORANGE, borderRadius: 24, padding: '12px 28px', fontWeight: 700, fontSize: 14, color: '#fff' }}>
              Find a Shop →
            </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <p style={{ color: '#fff', fontWeight: 700, fontSize: 15, margin: 0 }}>
            Roll Ready — Finance your new tires with Snap
          </p>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 12, margin: 0 }}>
            From <strong style={{ color: '#fff' }}>$14/week</strong> · No credit needed
          </p>
          <div style={{ background: ORANGE, borderRadius: 20, padding: '8px 20px', fontWeight: 700, fontSize: 12, color: '#fff', whiteSpace: 'nowrap' }}>
            Apply in Seconds
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', gap: 24, alignItems: 'flex-start', flexWrap: 'wrap' }}>
        ...
        <div style={{ width: 320, background: '#fff', borderRadius: 12, border: '1px solid #e5e7eb', overflow: 'hidden', fontFamily: 'Aeonik, sans-serif' }}>
          ...
          <div style={{ height: 160, overflow: 'hidden' }}>
            <img src="/images/goodyear.jpg" alt="Goodyear tire" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
          </div>
          <div style={{ padding: 20 }}>
            <p style={{ fontSize: 11, color: '#9ca3af', marginBottom: 4 }}>Big O Tires</p>
            <p style={{ fontWeight: 700, fontSize: 16, color: '#353849', marginBottom: 4 }}>Goodyear Assurance All-Season</p>
            <p style={{ fontSize: 22, fontWeight: 700, color: '#353849', marginBottom: 16 }}>$189.99 <span style={{ fontSize: 12, color: '#9ca3af', fontWeight: 400 }}>/ tire</span></p>

            {/* Snap widget */}
            <div style={{ background: DARK, borderRadius: 10, padding: 16, border: `1px solid ${ORANGE}30` }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: 12, marginBottom: 8 }}>
                Set of 4 as low as <strong style={{ color: '#fff' }}>$26/week</strong> with Snap Lease-to-Own
              </p>
              <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: 10, marginBottom: 12 }}>
                Perfect credit not required · Apply in seconds
              </p>
              <div style={{ background: ORANGE, borderRadius: 20, padding: '8px 0', textAlign: 'center', fontWeight: 700, fontSize: 12, color: '#fff' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #e5e7eb', padding: 20, maxWidth: 280, fontFamily: 'Aeonik, sans-serif' }}>
          <p style={{ color: ORANGE, fontSize: 10, fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 12 }}>Widget Notes</p>
          <ul style={{ fontSize: 11, color: '#6b7280', lineHeight: 1.7, paddingLeft: 18, margin: 0, listStyleType: 'disc' }}>
            ...
            <li>Shown at Big O, Discount Tire, Les Schwab, and local SLC shops</li>
            <li>Bilingual toggle available (EN/ES)</li>
            <li>100-Day payoff option surfaced for qualifying purchases</li>
          </ul>
        </div>
      </div>
    </div>
